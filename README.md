...
Vyasa is built on an opinionated documentation framework — a taxonomy for where information lives, guides for writing each doc type, and an audit process for finding problems. See [Managing project information](plugin/framework/managing-project-information.md) if you want to understand or contribute to the underlying guidelines.
